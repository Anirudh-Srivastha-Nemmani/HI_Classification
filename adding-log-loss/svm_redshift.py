...
grid_search = GridSearchCV(pipeline_svm, param_grid=param_dist, scoring=score_list, refit='roc_auc', cv=cv, n_jobs=30, return_train_score=True)
grid_search.fit(X, y)
...
cv_results.to_csv('/home/anirudh.nemmani/Projects/misc/more_misc/HI_ML/results/grid_search_results_svm_redshift.csv')
...
print(df)
df.to_csv('/home/anirudh.nemmani/Projects/misc/more_misc/HI_ML/results/grid_search_ranks_svm_redshift.csv')
